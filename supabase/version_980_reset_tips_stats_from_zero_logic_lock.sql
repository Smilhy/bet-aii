-- WERSJA 980 — RESET TYPÓW I STATYSTYK OD ZERA + JEDNA LOGIKA DLA WSZYSTKICH
...
-- Napraw generic username typu "user" tam, gdzie da się wziąć nick z public_slug albo emaila.
