-- WERSJA 1425 — DIAGNOSTYKA / HOTFIX WYDAJNOŚCI DM + SPOŁECZNOŚĆ
-- Wklej w Supabase SQL Editor i uruchom.
--
-- Nie usuwa danych. Dodaje indeksy pod prywatne wiadomości i podstawowe tabele społeczności.
-- Dodatkowo zostawia wyłączoną wolną funkcję get_recommended_tipsters_v1421.
...
select 'WERSJA 1425 performance hotfix indexes ready' as status;
