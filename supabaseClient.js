...
/* =========================================================
   VERSION 159 — ADMIN PAYOUTS UX PRO
   Filters, bulk actions, CSV export, one-click approve, premium SaaS layout.
   Keeps existing payout logic and Stripe/cron functions.
   ========================================================= */
.admin-payout-ux-pro{
  gap:18px!important;
}
.admin-kicker{
  ...
  border-radius:999px!important;
  background:rgba(31,226,174,.085)!important;
  border:1px solid rgba(31,226,174,.18)!important;
  color:#8bf6d5!important;
  font-size:11px!important;
  font-weight:1000!important;
  letter-spacing:.12em!important;
  text-transform:uppercase!important;
}
.admin-payout-hero-ux{
  min-height:124px!important;
  background:
    radial-gradient(circle at 16% 16%,rgba(31,226,174,.18),transparent 30%),
    radial-gradient(circle at 96% 8%,rgba(31,226,174,.20),transparent 28%),
    radial-gradient(circle at 74% 78%,rgba(87,166,255,.12),transparent 34%),
    linear-gradient(135deg,rgba(8,19,29,.99) 0%,rgba(7,25,32,.99) 55%,rgba(9,105,90,.93) 100%)!important;
}
.admin-payout-stats-ux>div em{
  display:block!important;
...
.admin-cron-card-ux strong small{
  display:inline-flex!important;
...
.admin-cron-actions b{color:#1fe2ae!important}
.admin-payout-toolbar{
  display:grid!important;
  grid-template-columns:minmax(260px,1.65fr) minmax(150px,.7fr) minmax(150px,.7fr) minmax(150px,.7fr) auto!important;
  gap:12px!important;
  padding:14px!important;
  border-radius:24px!important;
  background:linear-gradient(180deg,rgba(9,25,38,.96),rgba(5,12,19,.985))!important;
...
.admin-search-field{
  ...
  background:rgba(1,9,15,.58)!important;
  border:1px solid rgba(255,255,255,.08)!important;
  color:#7f95a8!important;
}
...
.admin-search-field input::placeholder{color:#6f8192!important}
...
.admin-filter-button{
  ...
  color:#1fe2ae!important;
  border-color:rgba(31,226,174,.18)!important;
}
.admin-bulk-bar{
  display:flex!important;
  align-items:center!important;
  ...
  border-radius:24px!important;
  background:
    radial-gradient(circle at 8% 16%,rgba(31,226,174,.13),transparent 28%),
    linear-gradient(180deg,rgba(9,25,38,.98),rgba(5,12,19,.99))!important;
...
.admin-secondary-action{
  ...
  border-radius:999px!important;
  border:1px solid rgba(31,226,174,.18)!important;
  background:rgba(31,226,174,.08)!important;
  color:#8bf6d5!important;
  font-weight:1000!important;
  cursor:pointer!important;
}
...
.admin-payout-table-ux .admin-payout-row{
  grid-template-columns:44px minmax(145px,1.05fr) minmax(145px,1.05fr) minmax(90px,.62fr) minmax(110px,.74fr) minmax(150px,1.05fr) minmax(170px,1.2fr)!important;
}
.admin-check-cell{display:flex!important;align-items:center!important;justify-content:center!important}
.admin-check{
...
.admin-check.selected{
  background:linear-gradient(135deg,#1fe2ae,#0b7a5f)!important;
  border-color:rgba(31,226,174,.48)!important;
}
.admin-check:disabled{opacity:.35!important;cursor:not-allowed!important}
.admin-user-cell{
  display:flex!important;
  flex-direction:column!important;
  gap:4px!important;
}
.admin-user-cell b{color:#f4fbff!important;font-size:13px!important}
.admin-user-cell small{color:#71879b!important;font-family:ui-monospace,SFMono-Regular,Menlo,monospace!important;font-size:11px!important;font-weight:800!important}
.admin-payout-table-ux .admin-payout-row.status-pending{box-shadow:inset 3px 0 0 rgba(245,158,11,.34)!important}
.admin-payout-table-ux .admin-payout-row.status-paid{box-shadow:inset 3px 0 0 rgba(31,226,174,.34)!important}
.admin-payout-table-ux .admin-payout-row.status-rejected{box-shadow:inset 3px 0 0 rgba(239,83,80,.34)!important}
.admin-payout-table-ux .admin-payout-row.status-processing{box-shadow:inset 3px 0 0 rgba(87,166,255,.34)!important}
.stripe-connect-note-ux{
  display:flex!important;
  align-items:center!important;
  justify-content:space-between!important;
  gap:18px!important;
}
.stripe-connect-note-ux button{
  position:relative!important;
  z-index:1!important;
  min-height:42px!important;
  padding:0 18px!important;
  border-radius:999px!important;
  background:rgba(31,226,174,.07)!important;
...
@media(max-width:1180px){
  ...
  .admin-payout-table-ux .admin-payout-row{grid-template-columns:1fr 1fr!important}
  .admin-payout-table-ux .admin-payout-row.header{display:none!important}
}
@media(max-width:760px){
  .admin-payout-toolbar{grid-template-columns:1fr!important}
  .admin-bulk-bar,.stripe-connect-note-ux,.admin-cron-actions{align-items:stretch!important;flex-direction:column!important}
  .admin-bulk-actions{justify-content:stretch!important}
  .admin-bulk-actions button,.stripe-connect-note-ux button{width:100%!important}
}
