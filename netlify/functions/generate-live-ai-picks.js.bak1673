...
exports.handler = async function (event) {
  try {
    ...
    return json(200, {
      ...
      model: '1086-daily-stable-scan-ai-bets-fixed',
      message: 'Skan AI zapisuje TOP typy do ai_bets dla zakładek dzisiaj/jutro. Tabela tips zostaje tylko dla kompatybilności.',
