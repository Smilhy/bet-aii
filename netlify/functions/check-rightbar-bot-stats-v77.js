...
exports.handler = async function(event) {
  ...
  try {
    ...
    return json(200, {
      ok: true,
      version: '77-rightbar-canonical-full-stats',
      typer_expert: { ...stats(typer.rows), query_errors: typer.errors },
      ograc_buka: { ...stats(ograc.rows), query_errors: ograc.errors },
      note: 'Te same pełne, deduplikowane historie są teraz dokładane do rankingu/prawej kolumny. Globalny limit 500 nie ucina już botów.'
    })
  } catch (error) {
