...
const { monitorHandler: monitorTyperSettlementV15 } = require('./_lib/ai-system-monitor')
exports.handler = monitorTyperSettlementV15({ systemKey: 'typer', runType: 'settlement' }, exports.handler)
